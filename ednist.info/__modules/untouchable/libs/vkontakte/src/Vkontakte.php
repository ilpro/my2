...
class Vkontakte
{
     ...
     */
    public function postToPublic($publicID, $text, $fullServerPathToImage, $link, $publish_time = null, $tags = array())
    {
        ...
        $response = $this->api('wall.post',
            [
                ...
                'from_group' => 1,
                'message' => "$text",
                'attachments' => "{$photo_id},{$link}", // uploaded image is passed as attachment
