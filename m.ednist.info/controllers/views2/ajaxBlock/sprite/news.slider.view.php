...
$block .= '<a href="/'.$newsType.'/'.$item["newsId"].'" class="item pull-left">';
$block .= '<img src="'.$ini["url.media"].'images/'.$item["newsId"].'/main/240.jpg" class="pull-left" alt="'.htmlentities($item['images']['main']['desc'] != ''?$item['images']['main']['desc']:$item['newsHeader'], ENT_QUOTES).'" title="'.htmlentities($item['images']['main']['desc'] != ''?$item['images']['main']['desc']:$item['newsHeader'], ENT_QUOTES).'">';
