<?
include "region/editregion.view.php";
    ...
    <div class="wrapper box" id="auth">
        ...
        <div class="head">
            ...
            <div class="search ui-widget">
                ...
                <input type="text" name="country" id="regions" placeholder="Поиск">
            ...
            <div class="filter floatRight">
                ...
                <div class="add" id="addRegion"><i></i></div>
        ...
        <div class="content" id="all-flavors">
            ...
            foreach ($page_data['regions'] as $item) {
