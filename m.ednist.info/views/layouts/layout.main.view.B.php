...
<head>
  ...
  <script async src="http://5.45.126.35:3000/media/media.js"></script>
  ...
  <!--    </script>-->
  <!-- END GOOGLE BANNERS -->
  <?= isset($page_data['material']['fbpixelCode']) ? $page_data['material']['fbpixelCode'] : "" ?>
</head>
<body>

<!--ad branding-->
<!--<div id="holder_5x5_40"></div>-->
<!--<script type="text/javascript">-->
...
<div class="main">
  <div class="phone-container">
    <a href="https://itunes.apple.com/us/app/ednist-operativno-ta-dostovirno/id999540645?ls=1&mt=8" target="_blank"
       class="left-phone">
  ...
  <div class="main-content">
    ...
    <div style="margin: 6px 0 0 0; height: 90px;">
      <!-- start  mediastealer media block-->
      <div class="msMedia" data-ms-media-id="2"></div>
      <!-- end  mediastealer media block -->
      <a class="pull-right dossier-banner"
         href="https://www.ednist.info/dossier/<?= $page_data['rand_brand']['brandId']; ?>">
        <img src="<?= $ini['url.media'] . "brand/" . $page_data['rand_brand']['brandId'] . "/main/240.jpg"; ?>">
        <span class="dossier-banner-info">
            <span class="dossier-banner-header">Досьє</span>
            <span class="dossier-banner-surname"><?= explode(" ", $page_data['rand_brand']['brandName'])[0]; ?></span>
            <span class="dossier-banner-name"><?= explode(" ", $page_data['rand_brand']['brandName'])[1]; ?></span>
            <span class="dossier-banner-name"><?= explode(" ", $page_data['rand_brand']['brandName'])[2]; ?></span>
        </span>
      </a>
    </div>
    <!-- end  mediastealer media block -->
