...
<!--        <a class="bottom-block pull-left" href="/newyear/"><img src="/assets/img/new_year_banner.png"></a>-->
        <a href="https://www.ednist.info/about" class="site-info pull-right">Інформаційне агентство «єдність»</a>
...
<div class="menu-container">
    ...
    <?include Config::getRoot()."/views/banners/top-banner.view.php";?>